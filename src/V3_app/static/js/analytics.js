...
+                // <<< Explicitly call render after update >>>
+                reportChartInstance.render();
+                console.log("[Charting - highlight] Explicit render() called.");
    ...
    */
    ...
    const chartSearchStatus = document.getElementById('chart-search-status'); // <<< ADD Declaration
